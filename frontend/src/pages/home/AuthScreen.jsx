      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        ...
        >
          ...
          <button className="bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center">
            Get Started <ChevronRight className="size-8 md:size-9" />
          </button>
        </form>
      </div>
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col  px-4 md:px-2">
          ...
          <div className="flex-1 text-center md:text-left">
            <h2 className="text-4xl nd:text-5xl font-extrabold mb-4">
              Enjoy on your TV
            </h2>
          ...
          <div className="flex-1 relative">
            <img src="/tv.png" alt="tv image" className="mb-4 z-10 relative" />
            <video
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse  px-4 md:px-2">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl">
              Save your favourites easily and always have somthing to watch.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col  px-4 md:px-2">
          ...
          <div className="flex-1 relative overflow-hidden">
            ...
            />
            <video
              className="absolute top-2 left-1/2 -translate-x-1/2 z-0 max-w-[63%] h-4/6"
              playsInline
              autoPlay
              muted
              loop
